...
<div class="contact-form">
	<form id="contact-form" action="<?php echo JRoute::_('index.php'); ?>"
		...
		<fieldset>
			...
			<dl>
				...
				<dt>
					...
					<span class="optional"><?php echo JText::_('COM_CONTACT_OPTIONAL');?>
					</span>
					<?php endif; ?>
				</dt>
				<dd>
				...
				<dd>
					...
					<input type="hidden" name="option" value="com_contact" /> <input
						...
						name="id" value="<?php echo $this->contact->slug; ?>" />
