...
<div class="content-links">
	<ul>
		...
		?>
		<li class="content-links-<?php echo $id; ?>"><?php
		...
		switch ($target)
		{
			...
			case 3:
				...
				JHtml::_('behavior.modal', 'a.modal'); ?> <a class="modal"
			href="<?php echo htmlspecialchars($link); ?>"
			rel="{handler: 'iframe', size: {x:600, y:600}}"> <?php echo htmlspecialchars($label) . ' </a>';
			break;
