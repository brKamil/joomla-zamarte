...
<table cellpadding="0" cellspacing="0"
	...
	<tr>
		<td><strong> <a
				href="<?php echo htmlspecialchars(str_replace('&', '&amp;', $channel['link'])); ?>"
				target="_blank"> <?php echo htmlspecialchars($channel['title']); ?>
			</a>
		</strong>
		</td>
	</tr>
	<?php
			...
			?>
	<tr>
		<td><?php echo $channel['description']; ?>
		</td>
	</tr>
	<?php
			}
			...
			?>
	<tr>
		<td align="center"><img src="<?php echo htmlspecialchars($iUrl); ?>"
		...
		<td>
			<ul class="newsfeed<?php echo htmlspecialchars($moduleclass_sfx); ?>">
				...
				if (!is_null($currItem->get_link())) {
					?> <a href="<?php echo htmlspecialchars($currItem->get_link()); ?>"
					target="_child"> <?php echo htmlspecialchars($currItem->get_title()); ?>
				</a> <?php
					}
