...
?>
<form action="<?php echo JRoute::_('index.php?option=com_checkin');?>"
	...
	<fieldset id="filter-bar">
		<div class="filter-search fltlft">
			<label class="filter-search-lbl" for="filter_search"><?php echo JText::_('JSEARCH_FILTER_LABEL'); ?>
				...
				title="<?php echo JText::_('COM_CHECKIN_FILTER_SEARCH_DESC'); ?>" />
	...
	<table id="global-checkin" class="adminlist">
		<thead>
			<tr>
				...
				<th class="left"><?php echo JHtml::_('grid.sort', 'COM_CHECKIN_DATABASE_TABLE', 'table', $listDirn, $listOrder); ?>
				</th>
				<th><?php echo JHtml::_('grid.sort', 'COM_CHECKIN_ITEMS_TO_CHECK_IN', 'count', $listDirn, $listOrder); ?>
				</th>
			</tr>
		</thead>
		<tbody>
