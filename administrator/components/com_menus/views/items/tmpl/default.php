	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th width="13%"><?php echo JHtml::_('grid.sort', 'JGRID_HEADING_ORDERING', 'a.lft', $listDirn, $listOrder); ?>
				...
				<th width="5%"><?php echo JHtml::_('grid.sort', 'COM_MENUS_HEADING_HOME', 'a.home', $listDirn, $listOrder); ?>
				</th>
				<?php
				$assoc = isset($app->menu_associations) ? $app->menu_associations : 0;
				if ($assoc):
				?>
				<th width="5%"><?php echo JHtml::_('grid.sort', 'COM_MENUS_HEADING_ASSOCIATION', 'association', $listDirn, $listOrder); ?>
				</th>
				<?php endif;?>
		...
		<tbody>
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td class="order"><?php if ($canChange) : ?> <?php if ($saveOrder) : ?>
					...
					<?php else : ?> <?php echo $orderkey + 1;?> <?php endif; ?>
				</td>
