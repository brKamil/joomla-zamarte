	...
	<table class="adminlist" id="modules-mgr">
		<thead>
			<tr>
				...
				<th width="10%"><?php echo JHtml::_('grid.sort',  'COM_MODULES_HEADING_PAGES', 'pages', $listDirn, $listOrder); ?>
				</th>
				<th width="10%"><?php echo JHtml::_('grid.sort', 'JGRID_HEADING_ACCESS', 'a.access', $listDirn, $listOrder); ?>
				</th>
				<th width="5%"><?php echo JHtml::_('grid.sort', 'JGRID_HEADING_LANGUAGE', 'language_title', $listDirn, $listOrder); ?>
				</th>
		...
		<tbody>
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td class="left"><?php if ($item->position) : ?> <?php echo $item->position; ?>
