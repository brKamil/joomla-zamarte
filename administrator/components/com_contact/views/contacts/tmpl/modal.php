...
?>
<form
	action="<?php echo JRoute::_('index.php?option=com_contact&view=contacts&layout=modal&tmpl=component&function='.$function);?>"
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th width="15%"><?php echo JHtml::_('grid.sort',  'JGRID_HEADING_ACCESS', 'access_level', $listDirn, $listOrder); ?>
				</th>
				<th width="15%"><?php echo JHtml::_('grid.sort', 'JCATEGORY', 'a.catid', $listDirn, $listOrder); ?>
				</th>
		...
		<tbody>
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td align="center"><?php if (!empty($item->linked_user)) : ?> <?php echo $item->linked_user;?>
					<?php endif; ?>
				</td>
				...
				<td align="center"><?php echo (int) $item->id; ?>
				</td>
			</tr>
			<?php endforeach; ?>
		</tbody>
