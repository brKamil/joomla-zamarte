...
<fieldset class="adminform">
	<legend>
		<?php echo JText::_('COM_TEMPLATES_MENUS_ASSIGNMENT'); ?>
	</legend>
	...
	<button type="button" class="jform-rightbtn"
		onclick="$$('.chk-menulink').each(function(el) { el.checked = !el.checked; });">
	...
	<div id="menu-assignment">
		...
		<ul class="menu-links">
			...
			<li class="menu-link"><input type="checkbox" name="jform[assigned][]"
				...
				<?php endif;?> /> <label for="link<?php echo (int) $link->value;?>">
					<?php echo $link->text; ?>
			</label>
			</li>
			<?php endforeach; ?>
