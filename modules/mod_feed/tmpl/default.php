...
<div style="direction: <?php echo $rssrtl ? 'rtl' :'ltr'; ?>; text-align: <?php echo $rssrtl ? 'right' :'left'; ?> ! important"  class="feed<?php echo $moduleclass_sfx; ?>">
	...
	<h4>
		<a href="<?php echo str_replace('&', '&amp', $feed->link); ?>"
			target="_blank"> <?php echo $feed->title; ?>
		</a>
	</h4>
	...
	<ul class="newsfeed<?php echo $params->get('moduleclass_sfx'); ?>">
		...
		for ($j = 0; $j < $totalItems; $j ++)
		{
			...
			// item title
			?>
		<li class="newsfeed-item"><?php	if (!is_null($currItem->get_link())) {
			...
			?> <a href="<?php echo $currItem->get_link(); ?>" target="_blank"> <?php echo $currItem->get_title(); ?>
		</a> <?php if (!is_null($feed->title) && $params->get('rsstitle', 1))
